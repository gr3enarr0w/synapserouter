...
func TrustDialog(dir string) (bool, error) {
	...
	fmt.Println("│                                                         │")
	fmt.Println("│  Trusting a folder allows synroute to execute code,     │")
	fmt.Println("│  write files, run commands, and use MCP servers on      │")
	fmt.Println("│  your behalf. Untrusted folders restrict synroute to    │")
